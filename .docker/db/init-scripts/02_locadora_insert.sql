...
('Joao Vitor', 'joao@email.com', '27911112222', '7654321', 'A12345', '12345678901', '1990-05-15', '2730001000', 'Rua do Cliente 1, 10', 2, 1),
...
('Ricardo Souza', 'ricardo@email.com', '71955556666', '1209876', 'E56789', '56789012345', '1995-03-10', NULL, 'Praca do Cliente 5, 50', 5, 5);
...
('ABC-1234', 2023, 'CHASSI123456ABC', 150.00, 1, 3, 1, 1, 1), -- Chevrolet Onix Plus, Flex, Disponivel, Popular
('DEF-5678', 2022, 'CHASSI234567DEF', 120.00, 2, 3, 2, 1, 1), -- Fiat Argo, Flex, Disponivel, Popular
('GHI-9012', 2024, 'CHASSI345678GHI', 180.00, 3, 1, 3, 4, 5), -- VW Virtus, Gasolina, Reservado, Sedan Medio
('JKL-3456', 2021, 'CHASSI456789JKL', 90.00, 4, 2, 4, 3, 1), -- Ford Ka, Etanol, Manutencao, Popular
...
('2025-02-01', NULL, 110.00, 5000, NULL, 5, 1, 3), -- Carro 5, Gerente 1, Cliente 3 (Locacao ativa)
('2025-02-15', '2025-02-18', 180.00, 15000, 15300, 3, 4, 4), -- Carro 3, Lider 4, Cliente 4
...
('2025-01-10', NULL, 4), -- Carro 4 (Manutencao em andamento)
...
(1, 1, '2024-12-28', 'Troca de oleo padrao.', 150.00),
(1, 2, '2024-12-29', 'Revisao e limpeza de pastilhas.', 80.00),
(2, 3, '2025-01-06', 'Alinhamento completo.', 120.00),
(3, 4, NULL, 'Aguardando chegada de pneus.', NULL), -- Servico em andamento
(4, 5, '2025-03-08', 'Lavagem e higienizacao interna.', 95.00);
