...
-- 12. Cliente (Depende de EstadoCivil e UF) -- Datas de Nascimento ajustadas
...
('João Vítor', 'joao@email.com', '27911112222', '7654321', 'A12345', '12345678901', '1985-05-15', '2730001000', 'Rua do Cliente 1, 10', 2, 1),
...
('Ricardo Souza', 'ricardo@email.com', '71955556666', '1209876', 'E56789', '56789012345', '1990-03-10', NULL, 'Praça do Cliente 5, 50', 5, 5);

-- 13. Veiculo (Depende de Fabricante, TipoCombustivel, ModeloVeiculo, SituacaoVeiculo, TipoVeiculo) -- Ano de Fabricação ajustado
...
('ABC-1234', 2017, 'CHASSI123456ABC', 150.00, 1, 3, 1, 1, 1), -- Chevrolet Onix Plus, Flex, Disponível, Popular
('DEF-5678', 2016, 'CHASSI234567DEF', 120.00, 2, 3, 2, 1, 1), -- Fiat Argo, Flex, Disponível, Popular
('GHI-9012', 2018, 'CHASSI345678GHI', 180.00, 3, 1, 3, 4, 5), -- VW Virtus, Gasolina, Reservado, Sedan Médio
('JKL-3456', 2015, 'CHASSI456789JKL', 90.00, 4, 2, 4, 1, 1), -- Ford Ka, Etanol, AGORA DISPONÍVEL (manutenção encerrada)
('MNO-7890', 2017, 'CHASSI567890MNO', 110.00, 5, 3, 5, 2, 1); -- Renault Kwid, Flex, Alugado, Popular

-- 14. Locacao (Depende de Veiculo, Funcionario e Cliente) -- Datas de Locação ajustadas
...
('2018-02-01', NULL, 110.00, 5000, NULL, 5, 1, 3), -- Carro 5, Gerente 1, Cliente 3 (Locação ativa)
('2018-02-15', '2018-02-18', 180.00, 15000, 15300, 3, 4, 4), -- Carro 3, Líder 4, Cliente 4
('2018-03-01', '2018-03-05', 90.00, 30000, 30600, 4, 2, 5); -- Carro 4, Atendente 2, Cliente 5

-- 15. ManutencaoVeiculo (Depende de Veiculo) -- Manutenção 3 concluída (dtRetorno adicionado)
...
('2018-01-10', '2018-01-20', 4), -- Carro 4 (Manutenção CONCLUÍDA)
...
-- 17. ServicoManutencao (Depende de ManutencaoVeiculo e Servico) -- Serviço 3.4 concluído (dtConclusao e custo adicionados)
...
(1, 1, '2017-12-28', 'Troca de óleo padrão.', 150.00),
(1, 2, '2017-12-29', 'Revisão e limpeza de pastilhas.', 80.00),
(2, 3, '2018-01-06', 'Alinhamento completo.', 120.00),
(3, 4, '2018-01-19', 'Aguardando chegada de pneus.', 350.00), -- Serviço CONCLUÍDO
(4, 5, '2018-03-08', 'Lavagem e higienização interna.', 95.00);
